...
function PriceAssignment() {
    ...
    // Handlers for modal
    const showAddModal = () => {
        navigate('/price-assignment/add');
    };

    const showEditModal = (record) => {
        navigate(`/price-assignment/${record.serPriceVersionId}`);
    };
    ...
    const columns = [
        ...
        },
        {
            ...
            key: 'txtVersionCode',
            sorter: (a, b) => a.txtMenuFoodCode.localeCompare(b.txtVersionCode),
        },
        {
            title: 'Name',
            dataIndex: 'txtName',
